...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Mar 2019 pada 09.47
...
INSERT INTO `paket` (`paket_id`, `paket_nama`, `paket_tanggal`, `paket_harga`, `paket_keterangan`, `kp_id`) VALUES
(2, 'Foto Foto', '2019-03-10 16:11:47', 'Rp. 100.000', '<p>Deskripsi Paket</p>', 1);
...
CREATE TABLE `transaksi` (
  ...
  `transaksi_nama` varchar(50) DEFAULT NULL,
  `transaksi_hp` int(11) DEFAULT NULL,
  `transaksi_email` varchar(50) DEFAULT NULL,
  `transaksi_alamat` text,
...
(2, 'Administrator', 'admin', '123456', '0813566667777', 'admin@gmail.com', 'Jl. ratu sianum', 'a.jpg', 2);

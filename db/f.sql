...
CREATE TABLE `paket` (
  ...
  `paket_harga` int(50) DEFAULT NULL,
...
(4, 'Paket 1 (1 Hari 1 Acara)', '2019-03-13 09:54:01', 0, '<p>– Foto dengan 1 kamera dslr</p><p>– Video dengan 1 kamera dslr</p><p>– 1 DVD hasil video dokumentasi full edit</p><p>- transfer file foto(no edit) dan video (editing)</p><div><br></div>', 'video1.jpg', 1),
(5, 'Foto taking only (Just jepret, transfer file)', '2019-03-13 09:54:59', 0, '<p>– Foto all event, output file foto ditransfer di tempat setelah event atau di cd after event</p><p>– 1 kamera dslr</p><p>– Lokasi foto palembang (daerah lain pls confirm terlebih dahulu)</p>', 'video.jpg', 1),
(6, 'Video taking Only (shoot n transfer File Video):', '2019-03-13 09:55:49', 0, '<p>– Video all event, shoot & transfer file video on the spot</p><p>– 1 kamera dslr/mirrorless</p>', 'video2.jpg', 1),
(7, 'Video & photo drone + Pilot (shoot n transfer File Video)', '2019-03-13 09:56:47', 0, '<p>– Video all event, shoot &amp; transfer file video on the spot</p><p>– 1 drone dji phantom 3 advanced</p><p>- 1 hari full</p>', 'video.jpg', 1),
(8, 'Paket 1 (1 Hari 1 Acara)', '2019-03-13 09:54:01', 0, '<p>– Foto dengan 1 kamera dslr</p><p>– Video dengan 1 kamera dslr</p><p>– 1 DVD hasil video dokumentasi full edit</p><p>- transfer file foto(no edit) dan video (editing)</p><div><br></div>', 'video.jpg', 2),
(9, 'Foto taking only (Just jepret, transfer file)', '2019-03-13 09:54:59', 0, '<p>– Foto all event, output file foto ditransfer di tempat setelah event atau di cd after event</p><p>– 1 kamera dslr</p><p>– Lokasi foto palembang (daerah lain pls confirm terlebih dahulu)</p>', 'video.jpg', 2),
(10, 'Video taking Only (shoot n transfer File Video):', '2019-03-13 09:55:49', 0, '<p>– Video all event, shoot &amp; transfer file video on the spot</p><p>– 1 kamera dslr/mirrorless</p>', 'video.jpg', 2),
(11, 'Video & photo drone + Pilot (shoot n transfer File Video)', '2019-03-13 09:56:47', 0, '<p>– Video all event, shoot &amp; transfer file video on the spot</p><p>– 1 drone dji phantom 3 advanced</p><p>- 1 hari full</p>', 'video.jpg', 2),
(12, 'Paket 1 (1 Hari 1 Acara)', '2019-03-13 09:54:01', 0, '<p>– Foto dengan 1 kamera dslr</p><p>– Video dengan 1 kamera dslr</p><p>– 1 DVD hasil video dokumentasi full edit</p><p>- transfer file foto(no edit) dan video (editing)</p><div><br></div>', 'video.jpg', 3),
(13, 'Foto taking only (Just jepret, transfer file)', '2019-03-13 09:54:59', 0, '<p>– Foto all event, output file foto ditransfer di tempat setelah event atau di cd after event</p><p>– 1 kamera dslr</p><p>– Lokasi foto palembang (daerah lain pls confirm terlebih dahulu)</p>', 'video.jpg', 3),
(14, 'Video taking Only (shoot n transfer File Video):', '2019-03-13 09:55:49', 0, '<p>– Video all event, shoot &amp; transfer file video on the spot</p><p>– 1 kamera dslr/mirrorless</p>', 'video.jpg', 3),
(15, 'Video & photo drone + Pilot (shoot n transfer File Video)', '2019-03-13 09:56:47', 2500000, '<p>– Video all event, shoot & transfer file video on the spot</p><p>– 1 drone dji phantom 3 advanced</p><p>- 1 hari full</p>', 'video.jpg', 3);
...
INSERT INTO `pemesanan` (`pemesanan_id`, `pemesanan_nama`, `pemesanan_email`, `pemesanan_alamat`, `pemesanan_nohp`, `pemesanan_tanggal`, `pemesanan_tglawal`, `pemesanan_tglakhir`, `pemesanan_status`, `s_videografer`, `s_fotografer`, `s_pilot_drone`, `s_backup_data`, `s_koordinator_tim`, `s_editing`, `paket_id`) VALUES
(2, 'M.Puji Lesmana', 'pujilesmana23@gmail.com', 'Jln.Sultan Agung Palembang Sumatera Selatan', '089606603036', '2019-03-27', '2019-04-04 17:00:00', '2019-03-27 17:00:00', 1, 2, 0, 0, 0, 0, 0, 5),
(4, 'M.Puji Lesmana', 'muhammadpuji63@gmail.com', 'Jln.Sultan Agung Palembang Sumatera Selatan', '089606603036', '2019-03-27', '2019-03-19 17:00:00', '2019-03-27 17:00:00', 1, 2, 0, 0, 0, 0, 0, 6),
(5, 'PPHI Lawfirm', 'muhammadpuji63@gmail.com', 'L. R. Soekamto Komp PTC (Palembang Trade Centere) MALL Blok H. 1 No. 066 Lantai 3 Kel. 8 ilir Kec. Ilir Timur II Palembang 30114\r\n-', '089606603036', '2019-03-27', '2019-03-26 17:00:00', '2019-03-11 17:00:00', 0, 0, 0, 0, 0, 0, 0, 5),
(6, 'M.Puji Lesmana', 'muhammadpuji63@gmail.com', 'Jln.Sultan Agung Palembang Sumatera Selatan\r\n-', '081365541955', '2019-03-27', '2019-03-22 17:00:00', '2019-03-24 17:00:00', 0, 0, 0, 0, 0, 0, 0, 5);
...
CREATE TABLE `transaksi` (
  ...
  `transaksi_harga` int(50) DEFAULT NULL,

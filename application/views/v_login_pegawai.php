...
<!--=================================
 ...
 <!--=================================
 login-->
<section class="height-100vh d-flex align-items-center page-section-ptb login" style="background-image: url(<?php echo base_url()?>assets/admin/images/background.jpg); background-repeat: no-repeat; background-size: 100% 100%" >
  <div class="container">
    ...
    <div class="col-lg-4 col-md-6 bg-white">
        <div class="login-fancy pb-40 clearfix">
          <h3 class="mb-30">Log In Pegawai</h3>
          <div>
            <p><?php echo $this->session->flashdata('msg');?></p>
          </div>
          <form action="<?php echo base_url().'Pegawai/Login_Pegawai/authadmin'?>" method="post" role="form" name="loginForm" novalidate="">
